        ...
        <Box sx={styles.contentBox}>
          ...
          <Grid sx= {styles.grid}>
            {data.features.map((feat,i) => (
              <Box sx={styles.card} key={feat.id}>
                <Image src={feat.imgSrc} altText={feat.altText} sx={styles.icon}/>

                <Box sx={styles.wrapper}>
                  <Heading sx={styles.wrapper.title}>{feat.title}</Heading>
                  <Text sx={styles.wrapper.subTitle}>{feat.text}</Text>
                </Box>
              </Box>
            ))}
          </Grid>
